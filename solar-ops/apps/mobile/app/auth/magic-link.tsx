    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.content}>
          ...
          <Text style={styles.desc}>We sent a magic link to {email}. Tap the link in your email to sign in.</Text>
    ...
    <SafeAreaView style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Enter your email to receive a secure sign-in link</Text>
        </View>
